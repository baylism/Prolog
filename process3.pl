...
process(L1, L2, Consistent, Inconsistent) :-
  findall((Name, Age, Other), match(L1, L2, Name, Age, Other), Consistent),
  findall((Name, Age, Other), nomatch(L1, L2, Name, Age, Other), Inconsistent).

match(L1, L2, Name, Age, Other) :-
  member((Name, Age), L1),
  member((Name, Age, Other), L2).

nomatch(L1, L2, Name, Age, Other) :-
  member((Name, Age, Other), L2),
  \+member((Name, Age), L1).
